...
This is a template for creating a new reusable LawPal Toolkit application.
...
To start a new app with this template::
    ...
    django-admin.py startapp --template=https://github.com/rosscdh/toolkit-app-template/archive/master.zip --extension=py,rst,in <app_name>
...
`full license text <https://github.com/rosscdh/toolkit-app-template/blob/master/LICENSE>`_  
